...
<div class="layout">
  ...
  <footer>
    ...
    <div class="footer-links">
      <span class="subtle">Models and downloads:</span>
      <a href="https://makerworld.com/en/@iprintstuffau" target="_blank" rel="noopener noreferrer">MakerWorld</a>
    </div>
    <div class="footer-links">
      <span class="subtle">Follow:</span>
      <a href="https://www.instagram.com/iprintstuffau" target="_blank" rel="noopener noreferrer" aria-label="iPrintStuff on Instagram" class="social-icon">
      ...
      <a href="https://www.facebook.com/iPrintStuffAu/" target="_blank" rel="noopener noreferrer" aria-label="iPrintStuff on Facebook" class="social-icon">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
        </svg>
      </a>
      <a href="https://github.com/thadius83/bambu-to-snapmaker-u1" target="_blank" rel="noopener noreferrer" aria-label="Source on GitHub" class="social-icon">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
